...
[[file:/assets/images/jetbrains-toolbox-app.jpg][使用 JetBrains Toolbox 可以很方便的管理你的项目和工具]]
...
[[file:/assets/images/settings-repository.png][设置 Setting Repository 的地址]]

#+BEGIN_QUOTE
如果你的没有找到这个选项的话，请确认一下是否开启了
[[https://plugins.jetbrains.com/plugin/7566-settings-repository]] 这个插件：

[[file:/assets/images/settings-repository-plugin.png]]
