...
[[file:/assets/images/https-tls-version.png][网站最高支持的 TLS 版本对比]]
...
[[file:/assets/images/https-key.png][网站使用证书的对比]]
...
[[file:/assets/images/https-sig.png][网站使用的签名证书的对比]]
...
[[file:/assets/images/http-status-code.png][HTTP 状态码]]
...
[[file:/assets/images/hsts-in-http-header.png][HTTP 响应头中的 HTST]]
...
[[file:/assets/images/htst-preloading.png][网站在 HSTS Preloading List 占比]]
...
[[file:/assets/images/https-ca.png][网站中 CA 占比]]
...
[[file:/assets/images/hpkp-in-http-header.png][HTTP 响应头中的 HPKP]]
...
[[file:/assets/images/certificate-transparency.png][certificate transparency]]
...
[[file:/assets/images/domain-length.png][域名的长度的分布]]

和顶级域名的分布：

[[file:/assets/images/tld.png][顶级域名的分布]]
